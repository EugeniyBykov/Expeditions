...
class APISettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="API_", env_file=ENV_FILE, extra="ignore"
    )
...
class APIDocsSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="API_DOCS_", env_file=ENV_FILE, extra="ignore"
    )
...
class RequestLoggingSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="REQUEST_LOG_", env_file=ENV_FILE, extra="ignore"
    )
...
class JWTSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="JWT_", env_file=ENV_FILE, extra="ignore"
    )
